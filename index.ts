...
while (attempts < UserInput) {
  ...
  if (guessNumber < randomNumber) {
    ...
    console.log(
      chalk.yellowBright(`Your number is greater than the computer number! Please try again`));
  } else if (guessNumber === randomNumber) {
    console.log(
      chalk.redBright(`Congratulations! Because your number (${guessNumber}) and computer number (${randomNumber}) is matched!`));
  } else {
    console.log(
      chalk.bgRedBright(
        `Try Again`
